...
{
    public partial class FinancialPlanView : System.Web.UI.Page
    {
        ...
        {
            var expensePriority1 = Session["priority1"];
            var expensePriority2 = Session["priority2"];
            finCompute.getPriority(System.Convert.ToString(expensePriority1), System.Convert.ToString(expensePriority2));
